...
<header>
    <nav class="bg-purple flex flex-col h-full overflow-x-hidden pb-4 pt-16 text-center text-white lg:fixed lg:left-0 lg:top-0 lg:w-64 lg:z-10">
        <div class="flex items-center justify-between pb-8 px-4 lg:p-0">
        ...
        <div id="menu" class="duration-700 ease-in-out pt-8 lg:flex lg:flex-col" hidden>
            <a href="" class="bg-black duration-300 ease-in font-bold hover:bg-white hover:no-underline hover:text-black mx-auto px-6 py-2 rounded-md text-lg text-white lg:w-1/2"><?php _e( 'Subscribe', 'ilovebeinganerd' ); ?></a>
...
<main class="flex-shrink-0 py-4 lg:ml-64">
    <div class="bg-black pt-8 px-4 relative sm:px-6 lg:px-8 lg:py-16">
                        ...
                        <div <?php post_class( 'blog-shadow duration-700 ease-in-out flex flex-col overflow-hidden rounded-lg lg:hover:scale-105' ); ?> id="post-<?php the_ID(); ?>">
                            ...
                            <div class="flex-1 p-6 flex flex-col justify-between">
                                ...
                                <div>
                                    ...
                                    <?php if( !empty( $terms ) ) : ?>
                                        <p class="text-sm font-medium"> <?php foreach( $terms as $term ) : ?><a href="<?php echo esc_url( get_term_link( $term ) ); ?>" class="hover:underline" rel="tag"><?php echo $term->name; ?></a><?php endforeach; ?> </p>
                                    <?php endif; ?>
		...
		&middot; </span>
                                ...
                                <div class="flex-1">
                                    <a href="#" class="block mt-2"> <p class="mt-3 text-base text-gray-500"><?php echo get_the_excerpt(); ?></p> </a>
                                </div>
